...
import * as serviceTypeSchemaJson from '../../Config/Schemas/schemas/serviceType.schema.json';
...
import * as dataSetClassIds from '../../Config/Constants/dataSetClassIds.json'; /*tslint:disable-line*/
